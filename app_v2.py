...
if st.button("Get Answer"):
    ...
    prompt = (
        ...
        "If multiple sources are present, you MUST follow this format:\n"
        "1. First state what Dharma Sasthra says\n"
        "2. Then state what Bhagavad Gita says\n"
        "3. Then explicitly explain how they connect\n"
        "If this structure is not followed, the answer is incorrect.\n"
